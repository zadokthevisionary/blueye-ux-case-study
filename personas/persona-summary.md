...
Uses a laptop/notebook daily for work-related tasks

Uses her phone for:

Social media and casual app use
...
Feels emotionally dependent on her phone for access and security

Appreciates digital tools when they are purpose-driven and infrequent
...
Feels annoyed and mentally drained when screen use is work-related

Feels trapped by the necessity of constant device access
...
Has had positive experiences with health-focused digital tools when they are:
...
Reduce eye strain and migraines caused by prolonged screen exposure
...
Existing tools don’t reduce physical strain enough
...
Uses devices for 100% of work-related tasks
...
Accepts screen time as unavoidable

Uses health-related tools selectively, primarily free versions
...
Extended screen use causes physical discomfort

Limited access to premium health features without payment
...
Uses a calorie-tracking app but finds it restrictive
...
Avoid worsening eye and head pain
...
Health tools that lock useful features behind paywalls
